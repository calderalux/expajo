...
export const PERMISSIONS = {
  ...
  PACKAGE_ITEMS: {
    CREATE: 'package_items:create',
    READ: 'package_items:read',
    UPDATE: 'package_items:update',
    DELETE: 'package_items:delete',
  },
  BOOKINGS: {
...
export const DEFAULT_ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  [UserRole.SUPER_ADMIN]: [
    ...
    PERMISSIONS.EXPERIENCES.DELETE,
    PERMISSIONS.PACKAGES.CREATE,
    PERMISSIONS.PACKAGES.READ,
    PERMISSIONS.PACKAGES.UPDATE,
    PERMISSIONS.PACKAGES.DELETE,
    PERMISSIONS.PACKAGE_ITEMS.CREATE,
    PERMISSIONS.PACKAGE_ITEMS.READ,
    PERMISSIONS.PACKAGE_ITEMS.UPDATE,
    PERMISSIONS.PACKAGE_ITEMS.DELETE,
