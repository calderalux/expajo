...
export async function GET(
  ...
  try {
    ...
    const experiences =
      await PackageExperienceService.getPackageExperiences(id);
...
export async function POST(
  ...
  try {
    ...
    const packageExperience =
      await PackageExperienceService.addExperienceToPackage(
        id,
...
export async function DELETE(
  ...
  try {
    ...
    await PackageExperienceService.removeExperienceFromPackage(
      id,
      experienceId
    );
...
export async function PUT(
  ...
  try {
    ...
    const packageExperience =
      await PackageExperienceService.updatePackageExperience(
        id,
        validationResult.data.experience_id,
        {
          is_optional: validationResult.data.is_optional,
